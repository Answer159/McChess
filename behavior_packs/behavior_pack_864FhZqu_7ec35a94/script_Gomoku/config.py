...
#  Custom（服务端 -> 客户端：通知玩家被混乱，客户端开启移动反向，见gomokuClientSystem）
ChaosConfuseEvent = "GomokuChaosConfuseEvent"
#  Custom（服务端 -> 客户端：通知玩家被时间停止，客户端关闭移动/跳跃/攻击输入，
#  见gomokuClientSystem）
...
StoneSideDict = {
    ...
    StoneBlueName: "blue", StoneBlueHardenedName: "blue",
    StoneGreenName: "green", StoneGreenHardenedName: "green",
    StoneGoldName: "gold",
}
...
#               'transfer' 转移符 / 'speed' 加速药水 / 'blackhole' 吞噬黑洞
...
# 阵营 -> 播报显示名
SideNameDict = {"white": "白方", "black": "黑方", "blue": "蓝方", "green": "绿方", "gold": "金棋子"}
